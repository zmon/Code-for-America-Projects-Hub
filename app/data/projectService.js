    ...
    function mockProjects() {
        this.projects = [{
        ...
        },
            {
                ...
                "issues": [{
                    "id": "58",
                    "descrip": "Organizations with multiple locations, what is the best way to input and display."
                },
            ...
            },
            {
                ...
                "issues": [
                    ...
                    {
                        "id": "16",
                        "descrip": "Script to display entered project data from Google spreadsheet in Google form to edit the data"
                    },
